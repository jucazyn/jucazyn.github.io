...
- **Fundamentals of Quantum Chemistry** taught by Prof. Luis H. da S. Lacerda  
  - In a nutshell: chem-oriented qm, based on (superb) [McQuarrie's book](https://books.google.com.br/books?id=zzxLTIljQB4C&printsec=frontcover&redir_esc=y#v=onepage&q&f=false)
- **Introduction to Python Programming** taught by Prof. Giovanni F. Caramori  
  - In a nutshell: chem-oriented programming, based on [Hill's book](https://scipython.com/about/the-book/)
