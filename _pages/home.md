...
In 2026, I'll begin my master's degree, continuing my research on physical theories. Alongside my academic goals for next year, I'm also open to part-time, remote opportunities in Artificial Intelligence. You can find my curriculum vitae [here](https://jucazyn.github.io/files/cv.pdf). If you believe my profile aligns with the needs of your team or projects, please feel free to email me.

## technical skills

On the theoretical side, my proficiency ranges from intermediate to advanced in areas including Mathematical Logic, Category Theory, Functional Analysis and Measure-theoretic Probability Theory. 

On the applied and computational side, I'm comfortable with Quantum Computing and, at an entry-level, with Machine Learning and Python.
