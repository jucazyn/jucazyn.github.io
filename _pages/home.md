...
The guiding thread of my research is the study of **equivalences** and **dualities**: how different things can be understood as "the same". This principle has profound implications, manifesting in Mathematics through relations between algebras and spaces, and its relevance extends across a broad spectrum of --- from the foundations of Logic and Quantum Physics to the frontiers of Linguistics and Artificial Intelligence.

One of the best formal tools today for mathematically approaching this is **Category Theory**, a metamathematical framework for comparing mathematical theories. And one of the main tools I _enthusiastically_ use. In Category Theory, the notion of equivalence and duality can be formalized in a very prolific way and it can be shown that Syntax and Semantics are dual of each other, a consequence of an important theorem called [Stone duality](https://en.wikipedia.org/wiki/Stone_duality).

In my current research, conducted at the [Research Group in Logic and Foundations of Science](https://sites.google.com/view/logicandfoundationsofscience/home?authuser=0) under the supervision of [Prof. Jonas R. Becker Arenhart](https://scholar.google.com/citations?user=INalU8cAAAAJ&hl=pt-BR), I'm studying the (possible) notions of equivalence of physical theories and we're examining how these notions connect to the broader **syntax-semantics debate** about the nature of scientific theories.
