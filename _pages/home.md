...
The guiding thread of my research is the study of **equivalences** and **dualities**: how different things can be seen as _the same_. This principle has profound implications, manifesting in Mathematics through relations between algebras and spaces, and its relevance extends across a broad _spectrum_ --- from the foundations of Logic and Quantum Physics to the frontiers of Linguistics and Artificial Intelligence.

Currently, under the supervision of [Prof. Jonas R. Becker Arenhart](https://scholar.google.com/citations?user=INalU8cAAAAJ&hl=pt-BR) at the [Research Group in Logic and Foundations of Science](https://sites.google.com/view/logicandfoundationsofscience/home?authuser=0), I'm studying the (possible) notions of equivalence of physical theories and we're examining how these notions connect to the broader **syntax-semantics debate** about the nature of scientific theories.
