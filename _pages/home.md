...
The guiding thread of my work is the study of **equivalence**, the central question of when different things can be understood as the same, and their applications. In Mathematics, it manifests in canonical dualities between algebraic and geometric structures. Its relevance extends across a broad _spectrum_ of disciplines — from Logic and Quantum Physics to Linguistics.
